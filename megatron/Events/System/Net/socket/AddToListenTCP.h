...
namespace socketEvent
{
    ...
    public:
        ...
        AddToListenTCP(const SOCKET_id& _socketId,const msockaddr_in  &_addr,const char* _socketDescription,const bool& _rebind,bool (*_bufferVerify)(const std::string& s),const route_t & r):
